...
- [ ] Learn the art of the deal (Soft Skills)
...
- Attıkları sunum şirkt içi sunumları, bir sürü capex var ama iş planlarına göre gittilerse bu capexlerin çoğunu çoktan harcamış olmalılar
- İlk yıl 78 GWh kullanmışlar önlisanstaki rakam, devamındaki yıllar 98 GWh yıllık %0.02 degradation ile kullanmışlar sunumdaki rakam. Hangisi doğru, neden
- 30 MW storage yazıyor bataryalı mı bu
- Lisansı alıp mı satıcaklar
- Yapı Ruhsatını alıp mı satıcaklar
- Biz lisans tadil yapıcaz mı
- Yapımdan ne kadarını yapacaklar teslim etmeden
- YEKDEM Formüllerini iste
...
- [ ] Pompaj Depolamalı Fizibilite 📅 2025-11-19 
	- [ ] Fizibilite
		...
		- Add MWh as üretim not re-optimization
		- 90 usd delta yapınca kurtarmıyor kaçta yapar diye görmek için duyarlılık
	- [ ] Sunum
		- Muhsin Beyden teminat ve sermaye yükümülüklerini öğren
		- Durumun günceli fotosu
			- 300MW PHES yapıcam
			...
			- ![[Pasted image 20251118105008.png]]
			- Problem 2: Büyük ihtimal bizde halihazırda olan SAnibey lisansına derç edilir nu parçası olduğu için bu zaman da bugün bir 20% sermaye göstermen gerekiyor
			- Süreci başlatalım mı sunumu
	- Araban Sanibey Pompaj depolamalılar için önfizibilite. Hidrodizayn raporu var halihazırda 
	- min 3 max 6 saaty çalışıyor. Doldurma için de boşaltma için de. Birinden birini yap hangisini yapman mantıklıysa AMA unique durumlarda fiyata göre ikisini de aynı anda yapmak printing money olabilir.
	- Matlab analiz et: Günde en az şu kadar üretim yapsın şu kadar delta yapsın ki feasible olsun.
	- Given a ptf prediction hourly and start stop constraints. Calculate optimal start stop schedule.
	Maliyet tahminlerinin referansları, geçmişte benzer projelerden edinilen deneyimler ile Japonya Uluslararası İşbirliği Ajansı (JICA) tarafından yayımlanan “Guideline and Manual for Hydropower Development” a
	
	Bu aşamada kamulaştırma bedelleri değerlendirme dışında bırakılmıştır.
...
- [ ] SMR fırsat analizi dokümanı 📅 2025-11-20 
	- Patrona hiç bimiyormuş gibi anlat
		- Su buharlaşıp türbin döndürüp elektrik üret
		- Radyoaktif bir madde bozunduğunda ısı açığa çıkıyor
		- Smal lolmasının farkı ne, Akkuyu ile farkı ne
	- Türkiye'ye nasıl gelir
	- Hangi şirket getirir
	- Yakıt nasıl gelir
	- Yakıtı biz üretebilir miyiz? ya da nereden alırız?
	- Kapasite olcak mı nasıl kullanırız?
	- Hem network oluşturmak için hem de sektör içi concessus ne, bizim dışarıdan göremediğimiz riskler neler onları anlayabilmek için Mayıstaki SMR konferansına gitme kararı çıkarttır.
	- Retiring energye bak SMR itiyaç mı.
	- Avantaj: is baseload, perdicatable
	- Decarbonization zournluluğu var mı (regulartory)
	- Momentum var mı bak stalmer uk önü açılacak mı
	- Soverignity bak kömür gaz outlsouyrcelanmak isteniyor mu ypoksa SMR dfaha mı iyi olur
	- Kapasite verilcek mi vak
	- Capacity factörü avantaj
	- ,Kaç fiyat vermeleri lazım ki irr15 olsun bul mesela
	- kim haleu kullanıyor hem çok riskili hem limited give supplier names amborgo ve nükleer silah olasılıkları.
	- Suppliers bak.
	- Her reaktör tiinde en yüksek ebitda verenden .
	- PESTEL ile risk analizi yap.
	- Needler için driber ile option chain yaz her need için.
	- Driber eksiklse görülür.
	- Need tipini classifyla foundational essential developmental symbolic mi diye
	- EEd seviyesine marshall keyness ile necessity convenience reifnement luxury
	- Sonuç
		- It is new, the technology is set to be very effective but it is not mature.
		- TR rekabet, WR rekabet
		- What can we do now?
			- Start shaking hands - both for reactor tech and fuel
			- Start building know how - if invest in CA we will want to transfer know how
			- Fuel tarafında üretici çok az, üretmeye başlasak çok iyi olur. We'll be the first in line to supply. Start from torium, work your way to uranium.  ÇİMKO'da sahip olduğumuz Madencilik ve işleme know howumuz torium fuel üretmek için yeterli.
			- Critical sugggestion for networking: SMR conference, only respected conference in the world. Center of gravity for the whole sector currently. MAy 2026 Texas.
	- ==Burdan git fırsat analizi templateı çıkart==
...
Under economic hardship you need to see the design choices you made because they were cheap. Because let's say you cant do something because it requires a lot of permits and money, see if by changing one of the previous economic design choices you made can be foregone to solve the permit problem.



- [ ] Çatalca'ya goldwind 120 fiyatı ve bakım fiyatı eklenecek
- [ ] Güneye goldwind 120 fiyatları ve bakım fiyatları eklenecek
- [ ] Güney fizibilite sunumlarına vestas da eklenecek
